import { ArrowLeft, Video, Image as ImageIcon, Mic, Sparkles } from "lucide-react";
...
function StudioNode({ title, icon, onClick }: any) {
  return (
    <button 
      onClick={onClick}
      className="w-full bg-zinc-900/30 border border-white/5 p-6 rounded-[30px] flex items-center justify-between group active:scale-[0.97] transition-all hover:bg-zinc-800/40"
    >
