  ...
  const studioTools = [
    {
      ...
      path: "/music", // 👈 App.tsx mein /music/:rest* hai, isliye /music work karega
    ...
    },
    {
      ...
      path: "/magic/video-gen", // 👈 App.tsx mein CinemaAI ka path yahi hai
    ...
    },
    {
      ...
      path: "/studio/voice-lab", // 👈 App.tsx mein yahi path hai
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white p-6 font-sans">
      <header className="flex items-center justify-between mb-10">
        <button onClick={() => setLocation("/hub")} className="p-4 bg-zinc-900 rounded-2xl border border-white/5 active:scale-75 transition-all">
          <ArrowLeft size={20}/>
        </button>
        <div className="text-center">
          <h2 className="text-2xl font-black italic tracking-tighter uppercase leading-none text-white">RX STUDIO</h2>
      ...
      <div className="space-y-4">
        {studioTools.map((tool) => (
          ...
          >
            ...
            <div className="p-3 bg-white/5 rounded-full relative z-10">
