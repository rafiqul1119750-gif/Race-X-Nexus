  ...
  useEffect(() => {
    ...
    if (watermarkHidden) {
      if (!existing) {
        ...
        style.textContent = `
          [data-replit-badge], .replit-ui-theme-root > footer,
          iframe[src*="replit"], #replit-badge { display: none !important; }
          body::after {
          ...
          <div className="space-y-6">
            ...
            <div className="glass-panel p-6 rounded-3xl max-w-lg">
              ...
              <div className="flex items-center justify-between p-4 bg-black/40 rounded-xl border border-white/10">
                <div>
                  <p className="font-bold text-white text-sm">Hide Replit Badge · Inject RX Footer</p>
